...
const sessionstore = new connectMdbSessStore({uri: mongoUri, collection: SESSION_COLLECTION, databaseName: config.DB_NAME})
...
export function sessionCleaner(req : express.Request, res : express.Response, next : Function) {
